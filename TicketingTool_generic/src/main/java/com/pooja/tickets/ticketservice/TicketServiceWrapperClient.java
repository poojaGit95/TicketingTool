...
public class TicketServiceWrapperClient {
    RestClient client;
    String baseURI;

    public TicketServiceWrapperClient(String baseURI, String username, String password){
        this.baseURI = baseURI;
        client = new RestClient(username, password);
    }

    @VisibleForTesting
    public TicketServiceWrapperClient(String baseURI, RestClient client){
        this.baseURI = baseURI;
        this.client = client;
    }
